...
it("renders link correctly", () => {
  const { asFragment } = renderWithTheme(<Link href="https://soulswap.pro">Link</Link>);
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      <a
        class="sc-bdfBwQ sc-gsTCUz cxXgLd djpNeP"
        color="primary"
        href="https://soulswap.pro"
      >
        Link
      </a>
    </DocumentFragment>
...
it("renders link external link correctly", () => {
  const { asFragment } = renderWithTheme(<LinkExternal href="https://soulswap.pro">Link</LinkExternal>);
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      <a
        class="sc-bdfBwQ sc-gsTCUz cxXgLd djpNeP"
